...
function History({ userSettings }: { userSettings: UserSettings }) {
    ...
    const formatter = useMemo(() => { return GetFormatterForCurrency(userSettings.currency) }, [userSettings.currency])
                    ...
                    <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                        ...
                        {!dataAvailable && (
                            <Card className=' flex h-[300px] flex-col items-center justify-center bg-background'>
                                ...
                                <p className=" text-sm text-muted-foreground">Try selecting a different period or adding new transaction</p>
                            </Card>
                        )}
                    </SkeletonWrapper>
                </CardContent>
