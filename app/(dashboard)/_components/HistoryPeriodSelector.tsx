"use client"
import { getHistoryPeriodsResposeType } from '@/app/api/history-periods/route'
...
function HistoryPeriodSelector({ period, setPeriod, timeframe, setTimeframe }: Props) {
    const historyPeriods = useQuery<getHistoryPeriodsResposeType>({
...
function YearSelector({
    ...
    period: Period;
    setPeriod: (period: Period) => void;
    years: getHistoryPeriodsResposeType
}) {
    return (
